...
>> For now, I prefer to use nano. It seems easiest to use, while vim has been the least intuitive.
...
>> I will use the Atom editor since I have the most experience with it and it has been intuitive to use.
